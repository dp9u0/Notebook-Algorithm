 ...
 * @property {number[][]} dist distances
 * @property {GraphVertex[][]} next next vertex
 */
    ...
    vertices.forEach((endVertex, endIndex) => {
      if (startVertex === endVertex) {
        ...
        if (edge) {
          ...
          dist[startIndex][endIndex] = edge.weight;
          next[startIndex][endIndex] = startVertex;
        } else {
  ...
  vertices.forEach((middleVertex, middleIndex) => {
    ...
    vertices.forEach((startVertex, startIndex) => {
      ...
      vertices.forEach((endVertex, endIndex) => {
        ...
        const distViaMiddle = dist[startIndex][middleIndex] + dist[middleIndex][endIndex];
        if (dist[startIndex][endIndex] > distViaMiddle) {
          ...
          next[startIndex][endIndex] = middleVertex;
        }
      });
    });
  });
