...
class MaxHeap {
  ...
  insert(value) {
    ...
    _heapifyUp(this.heap, this.heap.length - 1, (first, second) => this.comparator.greaterThanOrEqual(first, second));
  }
  ...
  pop() {
    ...
    if (!this.isEmpty) {
      ...
      _heapifyDown(this.heap, 0, (first, second) => this.comparator.greaterThanOrEqual(first, second));
    }
    return element;
  }
   ...
   */
  validate() {
    return _validate(this.heap, (first, second) => this.comparator.greaterThanOrEqual(first, second));
  }
